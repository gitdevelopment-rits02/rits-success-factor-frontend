...
const EmployeeViewOrgChart = () => {
    ...
    const { getOrgChartLoading: loading, orgChartData: data, getOrgChartError: error } = useSelector((state) => state.employee.orgChart);

    useEffect(() => {
        dispatch(employeeOrgChartThunk.getOrgChartThunk());
    }, [dispatch]);
                            ...
                            {activeTab === 'details' && (
                                <div className="space-y-5">
                                    ...
                                    {[
                                        ...
                                        { label: "Manager", value: selectedEmployee.reportingManager || "N/A" },
