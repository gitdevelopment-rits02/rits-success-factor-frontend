...
// export default function ChiefWorkforceWithHRAnalytics() {
//   return (
//     <div className="min-h-screen bg-slate-100 px-10 py-8 text-slate-800 font-sans">
//       {/* PAGE TITLE */}
//       <header className="mb-8">
//         <h1 className="text-2xl font-bold tracking-tight">Chief Dashboard</h1>
        ...
        <div className="flex-1 min-h-screen bg-blue-50/50 p-8 font-sans">
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="col-span-12 grid grid-cols-1 md:grid-cols-4 gap-6">
                    <StatCard icon={HiUsers} label="Total Staff" value="1,284" growth="+12%" color="blue" />
                    <StatCard icon={HiUserPlus} label="New Hires" value="24" growth="+4%" color="sky" />
                    <StatCard icon={HiCalendarDays} label="On Leave" value="12" sub="Currently out" color="indigo" />
                    <StatCard icon={HiCheckBadge} label="Retention" value="98.2%" growth="+0.4%" color="blue" />
                </div>
