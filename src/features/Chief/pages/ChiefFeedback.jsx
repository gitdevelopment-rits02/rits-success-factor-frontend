...
export default function ChiefFeedback() {
                                ...
                                hrData
                                    ...
                                    .map((hrItem) => (
                                        ...
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-full text-lg font-medium ${selectedHR?.hr === hrItem.hr
                                ...
                                managersData
                                    ...
                                    .map((m) => (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-full text-lg font-medium ${selectedManager?.manager === m.manager
                                                    ? "bg-blue-600 text-white"
                                                    : "bg-gray-100"
                                                }`}
                                        >
                                ...
                                .map((managerName) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-full text-sm font-medium ${selectedManager?.manager === managerName
                            ...
                            {selectedManager.reportees
                                ...
                                .map((emp) => (
                                    <span
                                        ...
                                        className={`px-4 py-2 rounded-full text-sm font-medium cursor-pointer whitespace-nowrap ${selectedEmployee === emp
                                                ? "bg-purple-600 text-white"
